...
DROP Function IF EXISTS create_payment_order_txns;
CREATE OR REPLACE FUNCTION public.create_payment_order_txns(p_status character varying, p_amount double precision, p_user_id integer, p_payment_type_id integer, p_payment_order_id integer, p_supplier_customer_id integer)
RETURNS json
LANGUAGE plpgsql
AS $function$
