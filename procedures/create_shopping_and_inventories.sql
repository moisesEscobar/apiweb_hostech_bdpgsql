...
BEGIN
    ...
    INSERT INTO shoppings (supplier_customer_id,date_purchase,created_at,updated_at) VALUES (v_supplier_id,v_date_purchase,NOW(), NOW()) RETURNING id INTO v_shopping_id;
    ...
    FOR v_product_details IN SELECT * FROM json_array_elements(v_product_details) LOOP
		...
		INSERT INTO shopping_details (shopping_id,inventory_id, unit_price,created_at,updated_at) VALUES (v_shopping_id,v_inventory_id, v_unit_price, NOW(), NOW());
    END LOOP;
